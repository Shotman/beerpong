 ...
 */
final class Version20240206104648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournament CHANGE challonge_id challonge_id VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournament CHANGE challonge_id challonge_id VARCHAR(255) DEFAULT NULL');
    }
}
